# 1 "../Application/src/stm32f4xx_syscfg.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../Application/src/stm32f4xx_syscfg.c"
# 50 "../Application/src/stm32f4xx_syscfg.c"
# 1 "../Application/src/stm32f4xx_syscfg.h" 1
# 38 "../Application/src/stm32f4xx_syscfg.h"
...
# 39 "../Application/src/stm32f4xx_syscfg.h" 2
# 188 "../Application/src/stm32f4xx_syscfg.h"
...
# 51 "../Application/src/stm32f4xx_syscfg.c" 2
# 100 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_DeInit(void)
{


 (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2RSTR |= (((uint32_t)0x00004000U)));
 (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2RSTR &= ~(((uint32_t)0x00004000U)));
}
# 120 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_MemoryRemapConfig(uint8_t SYSCFG_MemoryRemap)
{

    ((void)0);

    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->MEMRMP = SYSCFG_MemoryRemap;
}
# 141 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_MemorySwappingBank(FunctionalState NewState)
{

    ((void)0);

    *(volatile uint32_t *) (((uint32_t)0x42000000U) + ((((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U) - ((uint32_t)0x40000000U)) * 32) + (((uint8_t)0x8) * 4)) = (uint32_t)NewState;
}
# 164 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_EXTILineConfig(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex)
{
    uint32_t tmp = 0x00;
    ...
    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[EXTI_PinSourcex >> 0x02] &= ~tmp;
    ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[EXTI_PinSourcex >> 0x02] |= (((uint32_t)EXTI_PortSourceGPIOx) << (0x04 * (EXTI_PinSourcex & (uint8_t)0x03)));
}
# 185 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_ETH_MediaInterfaceConfig(uint32_t SYSCFG_ETH_MediaInterface)
{
    ((void)0);

    *(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x04) * 32) + (((uint8_t)0x17) * 4)) = SYSCFG_ETH_MediaInterface;
}
# 202 "../Application/src/stm32f4xx_syscfg.c"
void SYSCFG_CompensationCellCmd(FunctionalState NewState)
{

    ((void)0);

    *(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x20) * 32) + (((uint8_t)0x00) * 4)) = (uint32_t)NewState;
}
...
FlagStatus SYSCFG_GetCompensationCellStatus(void)
{
    ...
    if ((((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->CMPCR & ((uint32_t)0x00000100U) ) != (uint32_t)RESET)
    {
        bitstatus = SET;
    }
    else
