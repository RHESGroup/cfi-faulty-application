# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c"
# 33 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c"
...
# 34 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c" 2
...
# 35 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c" 2
...
int main(void)
{
 ...
 uint32_t i;
 for (i = 0; i < 256; i++) {
  vectorTable_RAM[i] = g_pfnVectors[i];
 }

 __disable_irq();
 ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (uint32_t)&vectorTable_RAM;
 __DSB();
 __enable_irq();
 ...
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U)), ((uint16_t)0x0008U), GPIO_PIN_RESET);

 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U)), ((uint16_t)0x0004U), GPIO_PIN_SET);
 HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U)), ((uint16_t)0x0004U), GPIO_PIN_RESET);
 uint16_t value2 = 2;
 uint16_t value4 = 4;
 uint16_t value8 = 8;
 uint16_t value16 = 16;
 uint32_t address = 0x60000000U;
# 105 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/main.c"
