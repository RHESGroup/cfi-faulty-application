# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
# 35 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.h" 1
# 42 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.h"
...
# 43 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.h" 2
...
void HAL_NOR_MspInit(NOR_HandleTypeDef* hnor);
void HAL_NOR_MspDeInit(NOR_HandleTypeDef* hnor);
# 36 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c" 2
...
# 38 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c" 2
...
void MX_FMC_Init(void)
{
  ...
  hnor1.Instance = ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000U) + 0x0000U));
  hnor1.Extended = ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000U) + 0x0104U));

  hnor1.Init.NSBank = ((uint32_t)0x00000000U);
  hnor1.Init.DataAddressMux = ((uint32_t)0x00000000U);
  hnor1.Init.MemoryType = ((uint32_t)0x00000008U);
  hnor1.Init.MemoryDataWidth = ((uint32_t)0x00000010U);
  hnor1.Init.BurstAccessMode = ((uint32_t)0x00000000U);
  hnor1.Init.WaitSignalPolarity = ((uint32_t)0x00000000U);
  hnor1.Init.WrapMode = ((uint32_t)0x00000000U);
  hnor1.Init.WaitSignalActive = ((uint32_t)0x00000000U);
  hnor1.Init.WriteOperation = ((uint32_t)0x00000000U);
  hnor1.Init.WaitSignal = ((uint32_t)0x00000000U);
  hnor1.Init.ExtendedMode = ((uint32_t)0x00000000U);
  hnor1.Init.AsynchronousWait = ((uint32_t)0x00000000U);
  hnor1.Init.WriteBurst = ((uint32_t)0x00000000U);
  hnor1.Init.ContinuousClock = ((uint32_t)0x00000000U);
  hnor1.Init.PageSize = ((uint32_t)0x00000000U);
  ...
  Timing.AccessMode = ((uint32_t)0x00000000U);


  HAL_NOR_Init(&hnor1, &Timing, 
# 81 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c" 3 4
                               ((void *)0)
# 81 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
                                   );



  hnor2.Instance = ((FMC_Bank1_TypeDef *) (((uint32_t)0xA0000000U) + 0x0000U));
  hnor2.Extended = ((FMC_Bank1E_TypeDef *) (((uint32_t)0xA0000000U) + 0x0104U));

  hnor2.Init.NSBank = ((uint32_t)0x00000002U);
  hnor2.Init.DataAddressMux = ((uint32_t)0x00000000U);
  hnor2.Init.MemoryType = ((uint32_t)0x00000008U);
  hnor2.Init.MemoryDataWidth = ((uint32_t)0x00000010U);
  hnor2.Init.BurstAccessMode = ((uint32_t)0x00000000U);
  hnor2.Init.WaitSignalPolarity = ((uint32_t)0x00000000U);
  hnor2.Init.WrapMode = ((uint32_t)0x00000000U);
  hnor2.Init.WaitSignalActive = ((uint32_t)0x00000000U);
  hnor2.Init.WriteOperation = ((uint32_t)0x00000000U);
  hnor2.Init.WaitSignal = ((uint32_t)0x00000000U);
  hnor2.Init.ExtendedMode = ((uint32_t)0x00000000U);
  hnor2.Init.AsynchronousWait = ((uint32_t)0x00000000U);
  hnor2.Init.WriteBurst = ((uint32_t)0x00000000U);
  hnor2.Init.ContinuousClock = ((uint32_t)0x00000000U);
  hnor2.Init.PageSize = ((uint32_t)0x00000000U);
  ...
  HAL_NOR_Init(&hnor2, &Timing, 
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c" 3 4
                               ((void *)0)
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
                                   );
...
static void HAL_FMC_MspInit(void){
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->AHB3ENR) |= (((uint32_t)0x00000001U))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->AHB3ENR) & (((uint32_t)0x00000001U))); ((void)(tmpreg)); } while(0);
# 160 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
  GPIO_InitStruct.Pin = ((uint16_t)0x0080U)|((uint16_t)0x0001U)|((uint16_t)0x0020U)|((uint16_t)0x0002U)
                          |((uint16_t)0x0010U)|((uint16_t)0x8000U)|((uint16_t)0x0400U)|((uint16_t)0x4000U)
  ...
  GPIO_InitStruct.Alternate = ((uint8_t)0x0CU);

  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0C00U)), &GPIO_InitStruct);


  GPIO_InitStruct.Pin = ((uint16_t)0x0001U)|((uint16_t)0x0002U)|((uint16_t)0x0004U)|((uint16_t)0x0008U)
                          |((uint16_t)0x0010U)|((uint16_t)0x0020U);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
  GPIO_InitStruct.Alternate = ((uint8_t)0x0CU);

  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1400U)), &GPIO_InitStruct);
  ...
  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U)), &GPIO_InitStruct);


  GPIO_InitStruct.Pin = ((uint16_t)0x0100U)|((uint16_t)0x0200U)|((uint16_t)0x0800U)|((uint16_t)0x4000U)
                          |((uint16_t)0x0080U)|((uint16_t)0x0400U)|((uint16_t)0x1000U)|((uint16_t)0x8000U)
                          |((uint16_t)0x2000U);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
  ...
  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1000U)), &GPIO_InitStruct);
...
static void HAL_FMC_MspDeInit(void){
  ...
  (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->AHB3ENR &= ~(((uint32_t)0x00000001U)));
# 257 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/fmc.c"
  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0080U)|((uint16_t)0x0001U)|((uint16_t)0x0020U)|((uint16_t)0x0002U)
                          |((uint16_t)0x0010U)|((uint16_t)0x8000U)|((uint16_t)0x0400U)|((uint16_t)0x4000U)
                          |((uint16_t)0x0200U)|((uint16_t)0x0100U));

  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1400U)), ((uint16_t)0x0001U)|((uint16_t)0x0002U)|((uint16_t)0x0004U)|((uint16_t)0x0008U)
                          |((uint16_t)0x0010U)|((uint16_t)0x0020U));

  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U)), ((uint16_t)0x0200U));

  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1000U)), ((uint16_t)0x0100U)|((uint16_t)0x0200U)|((uint16_t)0x0800U)|((uint16_t)0x4000U)
                          |((uint16_t)0x0080U)|((uint16_t)0x0400U)|((uint16_t)0x1000U)|((uint16_t)0x8000U)
                          |((uint16_t)0x2000U));
