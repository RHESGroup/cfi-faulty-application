# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
...
# 9 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.h" 2
...
uint16_t se3_algo_AesHmacSha256s_update(
    ...
    uint16_t datain2_len, const uint8_t* datain2,
    uint16_t* dataout_len, uint8_t* dataout);
# 8 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 2
 ...
 *myctx.direction = (direction == SE3_DIR_ENCRYPT) ? (0) : (1);
 ...
 case (SE3_DIR_ENCRYPT):
  switch (feedback) {
  case SE3_FEEDBACK_ECB: *(myctx.mode) = 2; break;
  case SE3_FEEDBACK_CBC: *(myctx.mode) = 4; break;
  case SE3_FEEDBACK_CTR: *(myctx.mode) = 8; break;
  case SE3_FEEDBACK_OFB: *(myctx.mode) = 1; break;
  case SE3_FEEDBACK_CFB: *(myctx.mode) = 6; break;
  default: return SE3_ERR_PARAMS;
  }
  break;
 case (SE3_DIR_DECRYPT):
  switch (feedback) {
  case SE3_FEEDBACK_ECB: *(myctx.mode) = 3; break;
  case SE3_FEEDBACK_CBC: *(myctx.mode) = 5; break;
  case SE3_FEEDBACK_CTR: *(myctx.mode) = 8; break;
  case SE3_FEEDBACK_OFB: *(myctx.mode) = 1; break;
  case SE3_FEEDBACK_CFB: *(myctx.mode) = 7; break;
  default: return SE3_ERR_PARAMS;
  }
  break;
 default:
...
# 100 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
_Bool 
# 100 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
     do_setnonce = (flags & SE3_CRYPTO_FLAG_SETNONCE);
 
# 101 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
_Bool 
# 101 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
     do_update = (datain2_len > 0);
 
# 102 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
_Bool 
# 102 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
     do_finit = (flags & SE3_CRYPTO_FLAG_FINIT);
 
# 103 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
_Bool 
# 103 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
     do_auth = (flags & SE3_CRYPTO_FLAG_AUTH);
 
# 104 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
_Bool 
# 104 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
     do_reset = (flags & SE3_CRYPTO_FLAG_RESET);
 ...
 if (do_setnonce) {
  ...
  if (( 0) != B5_Aes256_Init(myctx.aes, myctx.keys, *(myctx.key_size), *(myctx.mode))) {
   return SE3_ERR_PARAMS;
  }
  if (( 0) != B5_HmacSha256_Init(myctx.hmac, myctx.keys + (*(myctx.key_size)), *(myctx.key_size))) {
   return SE3_ERR_PARAMS;
  }
  *(myctx.state) = SE3_ALGO_STATE_KEYS_INITIALIZED;
 }
 else {
  if (do_reset && (datain1_len != 16 && datain1_len != 0)) {
   ;
   return SE3_ERR_PARAMS;
  }
  if (do_update && ((datain2_len % 16) != 0)) {
   return SE3_ERR_PARAMS;
  }

  if (*(myctx.state) == SE3_ALGO_STATE_KEYS_NOT_INITIALIZED) {

   PBKDF2HmacSha256(myctx.keys, *(myctx.key_size), 
# 144 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c" 3 4
                                                  ((void *)0)
# 144 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_AesHmacSha256s.c"
                                                      , 0, 1, myctx.keys, 2 * (*(myctx.key_size)));
   if (( 0) != B5_Aes256_Init(myctx.aes, myctx.keys, *(myctx.key_size), *(myctx.mode))) {
    return SE3_ERR_PARAMS;
   }
   if (( 0) != B5_HmacSha256_Init(myctx.hmac, myctx.keys + (*(myctx.key_size)), *(myctx.key_size))) {
  ...
  if (do_update) {
   nblocks = datain2_len / 16;

   if (*myctx.direction == 1) {
    if (( 0) != B5_HmacSha256_Update(myctx.hmac, datain2, datain2_len)) {
     return SE3_ERR_HW;
    }
    switch (*myctx.mode)
    {
    case 8:
    case 1:
     if (( 0) != B5_Aes256_Update(myctx.aes, pdataout, (uint8_t*)datain2, (uint16_t)nblocks)) {
      return SE3_ERR_HW;
     }
     break;
    default:
     if (( 0) != B5_Aes256_Update(myctx.aes, (uint8_t*)datain2, pdataout, (uint16_t)nblocks)) {
      return SE3_ERR_HW;
     }
    }
    ...
    if (( 0) != B5_HmacSha256_Update(myctx.hmac, pdataout, datain2_len)) {
     return SE3_ERR_HW;
    }
   }
