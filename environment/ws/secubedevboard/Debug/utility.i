# 1 "../Application/src/utility.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../Application/src/utility.c"

# 1 "../Application/src/utility.h" 1
...
uint8_t** split_string(uint8_t* buffer, char divisor, uint8_t isRaw){
 ...
 if(splits == 
# 29 "../Application/src/utility.c" 3 4
             ((void *)0)
# 29 "../Application/src/utility.c"
                 ){
  return 
# 30 "../Application/src/utility.c" 3 4
        ((void *)0)
# 30 "../Application/src/utility.c"
            ;
 }
 ...
 for(i = 0; i < numSplit+1; i++){
  ...
  if(splits[i] == 
# 50 "../Application/src/utility.c" 3 4
                 ((void *)0)
# 50 "../Application/src/utility.c"
                     ){
   return 
# 51 "../Application/src/utility.c" 3 4
         ((void *)0)
# 51 "../Application/src/utility.c"
             ;
  }
 ...
 if(splits == 
# 57 "../Application/src/utility.c" 3 4
             ((void *)0)
# 57 "../Application/src/utility.c"
                 ){
  return 
# 58 "../Application/src/utility.c" 3 4
        ((void *)0)
# 58 "../Application/src/utility.c"
            ;
 }
}
