# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c"
# 10 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c"
...
# 3 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.h" 2
...
uint16_t se3_algo_HmacSha256_update(
 ...
 uint16_t datain2_len, const uint8_t* datain2,
 uint16_t* dataout_len, uint8_t* dataout);
# 11 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c" 2
...
uint16_t se3_algo_HmacSha256_init(se3_flash_key* key, uint16_t mode, uint8_t* ctx)
{
 ...
 if (( 0) != B5_HmacSha256_Init(sha_hmac, key->data, key->data_size)) {
  ;
  return (SE3_ERR_PARAMS);
 }
...
# 38 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c" 3 4
_Bool 
# 38 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c"
     do_update = (datain1_len > 0);
 
# 39 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c" 3 4
_Bool 
# 39 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_HmacSha256.c"
     do_finit = (flags & SE3_CRYPTO_FLAG_FINIT);

 if (do_update) {

  if (( 0) != B5_HmacSha256_Update(sha_hmac, datain1, datain1_len)) {
   ;
   return SE3_ERR_HW;
  }
 }
 ...
 if (do_finit) {
  if (( 0) != B5_HmacSha256_Finit(sha_hmac, dataout)) {
   ;
   return SE3_ERR_HW;
  }
  *dataout_len = 32;
