# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 29 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_ctlreq.h" 1
# 37 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_ctlreq.h"
...
# 38 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_ctlreq.h" 2
...
# 30 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
...
# 39 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_core.h"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_ioreq.h" 1
...
uint16_t USBD_GetRxCount (USBD_HandleTypeDef *pdev ,
                           uint8_t epnum);
# 31 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 2
# 79 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 119 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdDevReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
...
# 170 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdItfReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
  USBD_StatusTypeDef ret = USBD_OK;
  ...
  case 3:
    ...
    if (((uint8_t)(req->wIndex & 0x00FF)) <= 1)
    {
...
# 207 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
USBD_StatusTypeDef USBD_StdEPReq (USBD_HandleTypeDef *pdev , USBD_SetupReqTypedef *req)
{
  ...
  ep_addr = ((uint8_t)(req->wIndex & 0x00FF));
...
# 449 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_SetAddress(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
  uint8_t dev_addr;
...
# 491 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_SetConfig(USBD_HandleTypeDef *pdev ,
                           USBD_SetupReqTypedef *req)
{
...
# 568 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_GetConfig(USBD_HandleTypeDef *pdev ,
                           USBD_SetupReqTypedef *req)
{
...
# 608 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_GetStatus(USBD_HandleTypeDef *pdev ,
                           USBD_SetupReqTypedef *req)
{
...
# 648 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_SetFeature(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
...
# 669 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
static void USBD_ClrFeature(USBD_HandleTypeDef *pdev ,
                            USBD_SetupReqTypedef *req)
{
  switch (pdev->dev_state)
...
# 698 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_ParseSetupRequest(USBD_SetupReqTypedef *req, uint8_t *pdata)
{
  req->bmRequest = *(uint8_t *) (pdata);
  req->bRequest = *(uint8_t *) (pdata + 1);
  req->wValue = (((uint16_t)(*((uint8_t *)(pdata + 2)))) + (((uint16_t)(*(((uint8_t *)(pdata + 2)) + 1))) << 8));
  req->wIndex = (((uint16_t)(*((uint8_t *)(pdata + 4)))) + (((uint16_t)(*(((uint8_t *)(pdata + 4)) + 1))) << 8));
  req->wLength = (((uint16_t)(*((uint8_t *)(pdata + 6)))) + (((uint16_t)(*(((uint8_t *)(pdata + 6)) + 1))) << 8));

}
# 716 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
...
# 732 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0;

  if (desc != 
# 736 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c" 3 4
             ((void *)0)
# 736 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c"
                 )
  {
