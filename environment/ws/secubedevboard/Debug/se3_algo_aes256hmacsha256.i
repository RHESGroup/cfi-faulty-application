# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
...
# 3 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.h" 2
...
uint16_t se3_algo_aes256hmacsha256_update(
    ...
    uint16_t datain2_len, const uint8_t* datain2,
    uint16_t* dataout_len, uint8_t* dataout);
# 2 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 2
    ...
    se3_flash_key* key, uint16_t mode, uint8_t* ctx)
{
 ...
 uint8_t derivated_key[64];
 switch (direction) {
 case (SE3_DIR_ENCRYPT):
  switch (feedback) {
  case SE3_FEEDBACK_ECB: b5_mode = 2; break;
  case SE3_FEEDBACK_CBC: b5_mode = 4; break;
  case SE3_FEEDBACK_CTR: b5_mode = 8; break;
  case SE3_FEEDBACK_OFB: b5_mode = 1; break;
  default: return SE3_ERR_PARAMS;
  }
  break;
 case (SE3_DIR_DECRYPT):
  switch (feedback) {
  case SE3_FEEDBACK_ECB: b5_mode = 3; break;
  case SE3_FEEDBACK_CBC: b5_mode = 5; break;
  case SE3_FEEDBACK_CTR: b5_mode = 8; break;
  case SE3_FEEDBACK_OFB: b5_mode = 1; break;
  default: return SE3_ERR_PARAMS;
  }
 ...
 PBKDF2HmacSha256(key->data, key->data_size, salt, 32, 1000, derivated_key, 64);
 if (( 0) != B5_HmacSha256_Init(hmacCtx, derivated_key + 32, 32)){
  ;
  return SE3_ERR_PARAMS;
 }
 if (( 0) != B5_Aes256_Init(aes, key->data, key->data_size, b5_mode)) {
  ;
  return SE3_ERR_PARAMS;
 }
    return SE3_OK;
...
# 68 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
   _Bool 
# 68 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
        do_setiv = 
# 68 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                   0
# 68 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
...
# 69 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
   _Bool 
# 69 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
        do_update = 
# 69 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                    0
# 69 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
...
# 70 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
   _Bool 
# 70 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
        do_finit = 
# 70 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                   0
# 70 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
 ...
 uint16_t direction = (flags & SE3_DIR_ENCRYPT) ? SE3_DIR_ENCRYPT : SE3_DIR_DECRYPT;
    ...
    if (datain1_len > 0) {
        ...
        do_setiv = 
# 83 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                  1
# 83 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
                      ;
    }
    ...
    if (datain2_len > 0) {
        ...
        do_update = 
# 91 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                   1
# 91 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
                       ;
  ...
  if (datain2_len > SE3_CRYPTO_MAX_DATAOUT - 32){
   ...
   return SE3_ERR_PARAMS;
    ...
    if (flags & SE3_CRYPTO_FLAG_FINIT) {
        do_finit = 
# 99 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c" 3 4
                  1
# 99 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_algo_aes256hmacsha256.c"
                      ;
    }
    ...
    if (do_setiv) {
        ...
        if (( 0) != B5_Aes256_SetIV(aes, datain1)) {
            ;
            return SE3_ERR_HW;
        }
    }
    ...
    if (do_update) {
        ...
        if (( 0) != B5_Aes256_Update(aes, data_enc, data_dec, (int16_t)nblocks)) {
            ;
            return SE3_ERR_HW;
        }
  ...
  if(( 0) != B5_HmacSha256_Update(hmacCtx, data_auth, datain2_len)){
   ;
   return SE3_ERR_HW;
  }
    ...
    if (do_finit) {
        if (( 0) != B5_Aes256_Finit(aes)) {
            ;
            return SE3_ERR_HW;
        }
  if (direction == SE3_DIR_ENCRYPT){
   if(( 0) != B5_HmacSha256_Finit(hmacCtx, data_enc+datain2_len)){
    ;
    return SE3_ERR_HW;
   }
  } else {
   if (( 0) != B5_HmacSha256_Finit(hmacCtx, old_auth)){
    ;
    return SE3_ERR_HW;
   }
