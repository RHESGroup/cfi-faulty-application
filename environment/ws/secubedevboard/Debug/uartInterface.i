# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/uartInterface.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/uartInterface.c"
...
# 2 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/uartInterface.c" 2
...
uint8_t sendCommand(struct output_buffer *commandBuffer, uint8_t hasStatus, uint16_t timeout)
{
 ...
 ret = HAL_UART_Transmit(&(commandBuffer->huart), commandBuffer->buffer, cmdLen, 0xFFFFFFFFU);
...
uint8_t logToDebugger(struct output_buffer *logBuffer, uint8_t flags)
{
 ...
 HAL_UART_Transmit(&(logBuffer->huart), logBuffer->buffer, strlen(logBuffer->buffer), 0xFFFFFFFFU);
}
...
void SystemClock_Config(void)
{
 ...
 do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB1ENR) |= (((uint32_t)0x10000000U))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB1ENR) & (((uint32_t)0x10000000U))); ((void)(tmpreg)); } while(0);
 do { volatile uint32_t tmpreg = 0x00U; (((((PWR_TypeDef *) (((uint32_t)0x40000000U) + 0x7000U))->CR)) = ((((((((PWR_TypeDef *) (((uint32_t)0x40000000U) + 0x7000U))->CR))) & (~(((uint32_t)0x0000C000U)))) | ((((uint32_t)0x0000C000U)))))); tmpreg = ((((PWR_TypeDef *) (((uint32_t)0x40000000U) + 0x7000U))->CR) & (((uint32_t)0x0000C000U))); ((void)(tmpreg)); } while(0);
 ...
 RCC_OscInitStruct.PLL.PLLSource = ((uint32_t)0x00400000U);
 ...
 RCC_ClkInitStruct.SYSCLKSource = ((uint32_t)0x00000002U);
 RCC_ClkInitStruct.AHBCLKDivider = ((uint32_t)0x00000000U);
 RCC_ClkInitStruct.APB1CLKDivider = ((uint32_t)0x00001400U);
 RCC_ClkInitStruct.APB2CLKDivider = ((uint32_t)0x00001000U);
 HAL_RCC_ClockConfig(&RCC_ClkInitStruct, ((uint32_t)0x00000005U));

 HAL_RCC_MCOConfig(((uint32_t)0x00000000U), ((uint32_t)0x00600000U), ((uint32_t)0x04000000U));
