# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
# 36 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
...
# 37 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c" 2
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.h" 1
# 42 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.h"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/core/Inc/usbd_def.h" 1
# 43 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.h" 2
# 78 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.h"
extern USBD_DescriptorsTypeDef HS_Desc;
# 38 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c" 2
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_conf.h" 1
# 39 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c" 2
# 88 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
...
# 103 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
USBD_DescriptorsTypeDef HS_Desc =
{
 ...
 uint8_t USBD_HS_DeviceDesc[0x12] __attribute__ ((aligned (4))) =
  {
    0x12,
    1,
    ...
    64,
    ((uint8_t)(1155 & 0x00FF)),
    ((uint8_t)((1155 & 0xFF00) >>8)),
    ((uint8_t)(22314 & 0x00FF)),
    ((uint8_t)((22314 & 0xFF00) >>8)),
    0x00,
    0x02,
    0x01,
    0x02,
...
# 178 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
 uint8_t USBD_LangIDDesc[0x04] __attribute__ ((aligned (4))) =
{
     0x04,
     3,
     ((uint8_t)(1033 & 0x00FF)),
     ((uint8_t)((1033 & 0xFF00) >>8)),
};




 uint8_t USBD_StrDesc[512] __attribute__ ((aligned (4)));
# 211 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_DeviceDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  *length = sizeof(USBD_HS_DeviceDesc);
  return USBD_HS_DeviceDesc;
}
# 224 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_LangIDStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  *length = sizeof(USBD_LangIDDesc);
  return USBD_LangIDDesc;
}
# 237 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_ProductStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString ((uint8_t *)"SECube", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString ((uint8_t *)"SECube", USBD_StrDesc, length);
...
# 257 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_ManufacturerStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  USBD_GetString ((uint8_t *)"SECube", USBD_StrDesc, length);
  return USBD_StrDesc;
}
# 270 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_SerialStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
...
# 290 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_ConfigStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  if(speed == USBD_SPEED_HIGH)
  {
...
# 310 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/usbd_desc.c"
uint8_t * USBD_HS_InterfaceStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  if(speed == 0)
  {
