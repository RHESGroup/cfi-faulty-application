# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
# 76 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
# 77 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 2
# 109 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum);
# 138 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  uint32_t i = 0U;
  ...
  if(hpcd == 
# 143 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 3 4
            ((void *)0)
# 143 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
                )
  {
    return HAL_ERROR;
  }
...
# 214 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
...
HAL_StatusTypeDef HAL_PCD_DeInit(PCD_HandleTypeDef *hpcd)
{
  ...
  if(hpcd == 
# 226 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c" 3 4
            ((void *)0)
# 226 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
                )
  {
    return HAL_ERROR;
  }
...
# 296 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Start(PCD_HandleTypeDef *hpcd)
{
  do{ if((hpcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpcd)->Lock = HAL_LOCKED; } }while (0);
  USB_DevConnect (hpcd->Instance);
  USB_EnableGlobalInt ((hpcd)->Instance);
  do{ (hpcd)->Lock = HAL_UNLOCKED; }while (0);
  return HAL_OK;
}
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
{
  ...
  if (USB_GetMode(hpcd->Instance) == 0U)
  {

    if((USB_ReadInterrupts((hpcd)->Instance) == 0U))
    {
      return;
    }

    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000002U))) == (((uint32_t)0x00000002U))))
    {

      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00000002U)));
    }

    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00080000U))) == (((uint32_t)0x00080000U))))
    {
      epnum = 0U;
      ...
      while ( ep_intr )
      {
        if (ep_intr & 0x1U)
        {
          ...
          if(( epint & ((uint32_t)0x00000001U)) == ((uint32_t)0x00000001U))
          {
            (((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (epnum)*((uint32_t )0x20U)))->DOEPINT = (((uint32_t)0x00000001U)));

            if(hpcd->Init.dma_enable == 1U)
            {
              hpcd->OUT_ep[epnum].xfer_count = hpcd->OUT_ep[epnum].maxpacket- (((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (epnum)*((uint32_t )0x20U)))->DOEPTSIZ & ((uint32_t)0x0007FFFFU));
          ...
          if(( epint & ((uint32_t)0x00000008U)) == ((uint32_t)0x00000008U))
          {

            HAL_PCD_SetupStageCallback(hpcd);
            (((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (epnum)*((uint32_t )0x20U)))->DOEPINT = (((uint32_t)0x00000008U)));
          }

          if(( epint & ((uint32_t)0x00000010U)) == ((uint32_t)0x00000010U))
          {
            (((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (epnum)*((uint32_t )0x20U)))->DOEPINT = (((uint32_t)0x00000010U)));
          }
# 400 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
        }
        epnum++;
        ep_intr >>= 1U;
      }
    ...
    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00040000U))) == (((uint32_t)0x00040000U))))
    {
      ...
      while ( ep_intr )
      {
        if (ep_intr & 0x1U)
        {
           ...
           if(( epint & ((uint32_t)0x00000001U)) == ((uint32_t)0x00000001U))
          {
            ...
            ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPEMPMSK &= ~fifoemptymsk;

            (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT = (((uint32_t)0x00000001U)));
           ...
           if(( epint & ((uint32_t)0x00000008U)) == ((uint32_t)0x00000008U))
          {
            (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT = (((uint32_t)0x00000008U)));
          }
          if(( epint & ((uint32_t)0x00000010U)) == ((uint32_t)0x00000010U))
          {
            (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT = (((uint32_t)0x00000010U)));
          }
          if(( epint & ((uint32_t)0x00000040U)) == ((uint32_t)0x00000040U))
          {
            (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT = (((uint32_t)0x00000040U)));
          }
          if(( epint & ((uint32_t)0x00000002U)) == ((uint32_t)0x00000002U))
          {
            (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT = (((uint32_t)0x00000002U)));
          }
          if(( epint & ((uint32_t)0x00000080U)) == ((uint32_t)0x00000080U))
          {
    ...
    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x80000000U))) == (((uint32_t)0x80000000U))))
    {

      ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCTL &= ~((uint32_t)0x00000001U);
# 483 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
      {
        HAL_PCD_ResumeCallback(hpcd);
      }

      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x80000000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000800U))) == (((uint32_t)0x00000800U))))
    {
      if((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000001U)) == ((uint32_t)0x00000001U))
      {

        HAL_PCD_SuspendCallback(hpcd);
      }
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00000800U)));
    }
# 520 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00001000U))) == (((uint32_t)0x00001000U))))
    {
      ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCTL &= ~((uint32_t)0x00000001U);
      ...
      ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK |= 0x10001U;

      if(hpcd->Init.use_dedicated_ep1)
      {
        ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DOUTEP1MSK |= (((uint32_t)0x00000008U) | ((uint32_t)0x00000001U) | ((uint32_t)0x00000002U));
        ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DINEP1MSK |= (((uint32_t)0x00000008U) | ((uint32_t)0x00000001U) | ((uint32_t)0x00000002U));
      }
      else
      {
        ...
        ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DOEPMSK |= (((uint32_t)0x00000008U) | ((uint32_t)0x00000001U) | ((uint32_t)0x00000002U));

        ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPMSK |= (((uint32_t)0x00000008U) | ((uint32_t)0x00000001U) | ((uint32_t)0x00000002U));
      }
      ...
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00001000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00002000U))) == (((uint32_t)0x00002000U))))
    {
      USB_ActivateSetup(hpcd->Instance);
      hpcd->Instance->GUSBCFG &= ~((uint32_t)0x00003C00U);

      if ( USB_GetDevSpeed(hpcd->Instance) == 0U)
      {
        hpcd->Init.speed = 0U;
        hpcd->Init.ep0_mps = 512U ;
        hpcd->Instance->GUSBCFG |= (uint32_t)((9U << 10U) & ((uint32_t)0x00003C00U));
      }
      else
      {
        hpcd->Init.speed = 3U;
        hpcd->Init.ep0_mps = 64U ;
        hpcd->Instance->GUSBCFG |= (uint32_t)((5U << 10U) & ((uint32_t)0x00003C00U));
      }

      HAL_PCD_ResetCallback(hpcd);

      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00002000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000010U))) == (((uint32_t)0x00000010U))))
    {
      ((hpcd->Instance)->GINTMSK &= ~(((uint32_t)0x00000010U)));

      temp = USBx->GRXSTSP;

      ep = &hpcd->OUT_ep[temp & ((uint32_t)0x0000000FU)];

      if(((temp & ((uint32_t)0x001E0000U)) >> 17U) == 2U)
      {
        if((temp & ((uint32_t)0x00007FF0U)) != 0U)
        {
          USB_ReadPacket(USBx, ep->xfer_buff, (temp & ((uint32_t)0x00007FF0U)) >> 4U);
          ep->xfer_buff += (temp & ((uint32_t)0x00007FF0U)) >> 4U;
          ep->xfer_count += (temp & ((uint32_t)0x00007FF0U)) >> 4U;
        }
      }
      else if (((temp & ((uint32_t)0x001E0000U)) >> 17U) == 6U)
      {
    ...
    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000008U))) == (((uint32_t)0x00000008U))))
    {
      HAL_PCD_SOFCallback(hpcd);
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00000008U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00100000U))) == (((uint32_t)0x00100000U))))
    {
      HAL_PCD_ISOINIncompleteCallback(hpcd, epnum);
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00100000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00200000U))) == (((uint32_t)0x00200000U))))
    {
      HAL_PCD_ISOOUTIncompleteCallback(hpcd, epnum);
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x00200000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x40000000U))) == (((uint32_t)0x40000000U))))
    {
      HAL_PCD_ConnectCallback(hpcd);
      (((hpcd)->Instance->GINTSTS) &= (((uint32_t)0x40000000U)));
    }


    if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000004U))) == (((uint32_t)0x00000004U))))
    {
      temp = hpcd->Instance->GOTGINT;

      if((temp & ((uint32_t)0x00000004U)) == ((uint32_t)0x00000004U))
      {
...
# 834 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_DevConnect(PCD_HandleTypeDef *hpcd)
{
  do{ if((hpcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpcd)->Lock = HAL_LOCKED; } }while (0);
  USB_DevConnect(hpcd->Instance);
...
# 876 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Open(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint16_t ep_mps, uint8_t ep_type)
{
...
# 918 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Close(PCD_HandleTypeDef *hpcd, uint8_t ep_addr)
{
  USB_OTG_EPTypeDef *ep;
...
# 949 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Receive(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  USB_OTG_EPTypeDef *ep;
...
# 1000 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Transmit(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  USB_OTG_EPTypeDef *ep;
...
# 1177 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
PCD_StateTypeDef HAL_PCD_GetState(PCD_HandleTypeDef *hpcd)
{
  return hpcd->State;
}
# 1200 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
  USB_OTG_EPTypeDef *ep;
  ...
  while ( (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DTXFSTS & ((uint32_t)0x0000FFFFU)) > len32b &&
