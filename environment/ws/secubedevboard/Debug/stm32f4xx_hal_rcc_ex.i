# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
# 43 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
...
# 44 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c" 2
# 108 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
void HAL_RCC_DeInit(void)
{

  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CR) |= (((uint32_t)0x00000001U) | ((uint32_t)0x00000080U)));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CFGR) = (0x0));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CR) &= ~(((uint32_t)0x00010000U) | ((uint32_t)0x00080000U) | ((uint32_t)0x01000000U)| ((uint32_t)0x04000000U)));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLCFGR) = (0x0));
  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLCFGR) |= (((uint32_t)0x00000010U) | ((uint32_t)0x00001000U) | ((uint32_t)0x00002000U) | ((uint32_t)0x04000000U)));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR) = (0x0));
  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR) |= (((uint32_t)0x00001000U) | ((uint32_t)0x00002000U) | ((uint32_t)0x20000000U)));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CR) &= ~(((uint32_t)0x00040000U)));


  ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CIR) = (0x0));
}
# 1282 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  ...
  if((((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000001U)) == ((uint32_t)0x00000001U)) ||
     (((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000002U)) == ((uint32_t)0x00000002U)))
  {

    ((void)0);


    (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x00U) * 32) + (0x1A * 4)) = DISABLE);

    tickstart = HAL_GetTick();

    while((((((((((uint8_t)0x3BU)) >> 5U) == 1U)? ((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CR :((((((uint8_t)0x3BU)) >> 5U) == 2U) ? ((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR :((((((uint8_t)0x3BU)) >> 5U) == 3U)? ((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CSR :((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CIR))) & ((uint32_t)1U << ((((uint8_t)0x3BU)) & ((uint8_t)0x1FU))))!= 0U)? 1U : 0U) != RESET)
    {
    ...
    if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000001U)) == (((uint32_t)0x00000001U)))
    {
      ...
      (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR = (((PeriphClkInit->PLLI2S.PLLI2SN) << (__builtin_clz(__RBIT(((uint32_t)0x00007FC0U))))) | ((PeriphClkInit->PLLI2S.PLLI2SR) << (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))))));
    }
    ...
    if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000002U)) == (((uint32_t)0x00000002U)))
    {
      ...
      tmpreg1 = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR & ((uint32_t)0x70000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))));




      (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR = ((PeriphClkInit->PLLI2S.PLLI2SN) << 6) | ((PeriphClkInit->PLLI2S.PLLI2SQ) << 24) | ((tmpreg1) << 28));

      ((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR))) & (~(((uint32_t)0x0000001FU)))) | ((PeriphClkInit->PLLI2SDivQ)-1)))));
    }


    (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x00U) * 32) + (0x1A * 4)) = ENABLE);
  ...
  if((((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000004U)) == ((uint32_t)0x00000004U)) ||
     (((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000008U)) == ((uint32_t)0x00000008U)))
  {

    ((void)0);


    (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x00U) * 32) + (0x1C * 4)) = DISABLE);

    tickstart = HAL_GetTick();

    while(((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CR & (((uint32_t)0x20000000U))) == (((uint32_t)0x20000000U))) != RESET)
    {
      if((HAL_GetTick() - tickstart ) > ((uint32_t)2))
      {
    ...
    if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000004U)) == (((uint32_t)0x00000004U)))
    {
      ...
      tmpreg1 = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR & ((uint32_t)0x70000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))));



      (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR = (((PeriphClkInit->PLLSAI.PLLSAIN) << (__builtin_clz(__RBIT(((uint32_t)0x00007FC0U))))) | ((PeriphClkInit->PLLSAI.PLLSAIQ) << (__builtin_clz(__RBIT(((uint32_t)0x0F000000U))))) | ((tmpreg1) << (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))))));

      ((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR))) & (~(((uint32_t)0x00001F00U)))) | (((PeriphClkInit->PLLSAIDivQ)-1)<<8)))));
    }
    ...
    if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000008U)) == (((uint32_t)0x00000008U)))
    {
      ...
      tmpreg1 = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR & ((uint32_t)0x0F000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x0F000000U)))));



      (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR = (((PeriphClkInit->PLLSAI.PLLSAIN) << (__builtin_clz(__RBIT(((uint32_t)0x00007FC0U))))) | ((tmpreg1) << (__builtin_clz(__RBIT(((uint32_t)0x0F000000U))))) | ((PeriphClkInit->PLLSAI.PLLSAIR) << (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))))));

      ((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR))) & (~(((uint32_t)0x00030000U)))) | ((PeriphClkInit->PLLSAIDivR))))));
    }

    (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x00U) * 32) + (0x1C * 4)) = ENABLE);
  ...
  if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000020U)) == (((uint32_t)0x00000020U)))
  {
    ...
    if((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR & ((uint32_t)0x00000300U)) != (PeriphClkInit->RTCClockSelection & ((uint32_t)0x00000300U)))
    {


      tmpreg1 = (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR & ~(((uint32_t)0x00000300U)));

      (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x70U) * 32U) + (0x10U * 4U)) = ENABLE);
      (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x70U) * 32U) + (0x10U * 4U)) = DISABLE);

      ((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR = tmpreg1;


      if((((tmpreg1) & (((uint32_t)0x00000002U))) != RESET))
      {
      ...
      do { (((PeriphClkInit->RTCClockSelection) & ((uint32_t)0x00000300U)) == ((uint32_t)0x00000300U)) ? (((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CFGR))) & (~(((uint32_t)0x001F0000U)))) | (((PeriphClkInit->RTCClockSelection) & 0xFFFFCFFU))))) : ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CFGR) &= ~(((uint32_t)0x001F0000U))); ((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR |= ((PeriphClkInit->RTCClockSelection) & 0x00000FFFU); } while (0);
    }
  }
  ...
  {
    (*(volatile uint32_t *) (((uint32_t)0x42000000U) + (((((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U) - ((uint32_t)0x40000000U)) + 0x8C) * 32) + (0x18 * 4)) = (PeriphClkInit->TIMPresSelection));
  }
  return HAL_OK;
}
# 1503 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  uint32_t tempreg;


  PeriphClkInit->PeriphClockSelection = ((uint32_t)0x00000001U) | ((uint32_t)0x00000004U) | ((uint32_t)0x00000002U) | ((uint32_t)0x00000008U) | ((uint32_t)0x00000010U) | ((uint32_t)0x00000020U);


  PeriphClkInit->PLLI2S.PLLI2SN = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR & ((uint32_t)0x00007FC0U)) >> (__builtin_clz(__RBIT(((uint32_t)0x00007FC0U)))));
  PeriphClkInit->PLLI2S.PLLI2SR = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR & ((uint32_t)0x70000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))));
  PeriphClkInit->PLLI2S.PLLI2SQ = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLI2SCFGR & ((uint32_t)0x0F000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x0F000000U)))));

  PeriphClkInit->PLLSAI.PLLSAIN = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR & ((uint32_t)0x00007FC0U)) >> (__builtin_clz(__RBIT(((uint32_t)0x00007FC0U)))));
  PeriphClkInit->PLLSAI.PLLSAIR = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR & ((uint32_t)0x70000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x70000000U)))));
  PeriphClkInit->PLLSAI.PLLSAIQ = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->PLLSAICFGR & ((uint32_t)0x0F000000U)) >> (__builtin_clz(__RBIT(((uint32_t)0x0F000000U)))));

  PeriphClkInit->PLLI2SDivQ = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR & ((uint32_t)0x0000001FU)) >> (__builtin_clz(__RBIT(((uint32_t)0x0000001FU)))));
  PeriphClkInit->PLLSAIDivQ = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR & ((uint32_t)0x00001F00U)) >> (__builtin_clz(__RBIT(((uint32_t)0x00001F00U)))));
  PeriphClkInit->PLLSAIDivR = (uint32_t)(((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR & ((uint32_t)0x00030000U));

  tempreg = (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->CFGR & ((uint32_t)0x001F0000U));
  PeriphClkInit->RTCClockSelection = (uint32_t)((tempreg) | (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->BDCR & ((uint32_t)0x00000300U)));

  if ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->DCKCFGR & ((uint32_t)0x01000000U)) == RESET)
  {
