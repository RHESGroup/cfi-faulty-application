# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
# 29 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev,
                             uint8_t epnum);
# 30 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
...
# 31 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/class/msc/Inc/usbd_msc_scsi.h" 1
# 32 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c" 2
# 81 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
...
# 105 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_Init (USBD_HandleTypeDef *pdev)
{
...
# 166 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_DataIn (USBD_HandleTypeDef *pdev,
                     uint8_t epnum)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;
...
static void MSC_BOT_CBW_Decode (USBD_HandleTypeDef *pdev)
{
  ...
  if ((USBD_LL_GetRxDataSize (pdev ,0x01) != 31) ||
      (hmsc->cbw.dSignature != 0x43425355)||
        (hmsc->cbw.bLUN > 1) ||
...
# 299 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_SendData(USBD_HandleTypeDef *pdev,
                              uint8_t* buf,
                              uint16_t len)
{
  ...
  len = (((hmsc->cbw.dDataLength) < (len)) ? (hmsc->cbw.dDataLength) : (len));
  hmsc->csw.dDataResidue -= len;
  hmsc->csw.bStatus = 0x00;
  hmsc->bot_state = 4;

  USBD_LL_Transmit (pdev, 0x81, buf, len);
}
# 320 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_SendCSW (USBD_HandleTypeDef *pdev,
                              uint8_t CSW_Status)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;

  hmsc->csw.dSignature = 0x53425355;
...
# 349 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
static void MSC_BOT_Abort (USBD_HandleTypeDef *pdev)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;
  ...
  if ((hmsc->cbw.bmFlags == 0) &&
      ...
      (hmsc->bot_status == 0) )
  {
    USBD_LL_StallEP(pdev, 0x01 );
  }
  USBD_LL_StallEP(pdev, 0x81);

  if(hmsc->bot_status == 2)
  {
    USBD_LL_PrepareReceive (pdev,
                      0x01,
                      (uint8_t *)&hmsc->cbw,
...
# 378 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_bot.c"
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev, uint8_t epnum)
{
  ...
  else if(((epnum & 0x80) == 0x80) && ( hmsc->bot_status != 1))
  {
    MSC_BOT_SendCSW (pdev, 0x01);
  }
