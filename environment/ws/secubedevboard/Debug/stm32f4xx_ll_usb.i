# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
# 59 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
...
# 60 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c" 2
# 76 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
static HAL_StatusTypeDef USB_CoreReset(USB_OTG_GlobalTypeDef *USBx);
# 104 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_CoreInit(USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  if (cfg.phy_itface == 1U)
  {

    USBx->GCCFG &= ~(((uint32_t)0x00010000U));


    USBx->GUSBCFG &= ~(((uint32_t)0x00400000U) | ((uint32_t)0x00020000U) | ((uint32_t)0x00000040U));


    USBx->GUSBCFG &= ~(((uint32_t)0x00100000U) | ((uint32_t)0x00200000U));
    if(cfg.use_external_vbus == 1U)
    {
      USBx->GUSBCFG |= ((uint32_t)0x00100000U);
    }
  ...
  else
  {
    ...
    USBx->GUSBCFG |= ((uint32_t)0x00000040U);
  ...
  {
    USBx->GAHBCFG |= (((uint32_t)0x00000004U) | ((uint32_t)0x00000008U));
    USBx->GAHBCFG |= ((uint32_t)0x00000020U);
  }
...
HAL_StatusTypeDef USB_EnableGlobalInt(USB_OTG_GlobalTypeDef *USBx)
{
  USBx->GAHBCFG |= ((uint32_t)0x00000001U);
  return HAL_OK;
}
# 163 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_DisableGlobalInt(USB_OTG_GlobalTypeDef *USBx)
{
  USBx->GAHBCFG &= ~((uint32_t)0x00000001U);
  return HAL_OK;
}
# 179 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_SetCurrentMode(USB_OTG_GlobalTypeDef *USBx , USB_OTG_ModeTypeDef mode)
{
  USBx->GUSBCFG &= ~(((uint32_t)0x20000000U) | ((uint32_t)0x40000000U));

  if ( mode == USB_OTG_HOST_MODE)
  {
    USBx->GUSBCFG |= ((uint32_t)0x20000000U);
  }
  else if ( mode == USB_OTG_DEVICE_MODE)
  {
    USBx->GUSBCFG |= ((uint32_t)0x40000000U);
  }
  HAL_Delay(50U);

  return HAL_OK;
}
# 204 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_DevInit (USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  uint32_t i = 0U;
# 222 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
  USBx->GCCFG |= ((uint32_t)0x00080000U);

  if (cfg.vbus_sensing_enable == 0U)
  {
    USBx->GCCFG |= ((uint32_t)0x00200000U);
  }



  *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0xE00U)) = 0U;


  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCFG |= 0U;
  ...
  if(cfg.phy_itface == 1U)
  {
    if(cfg.speed == 0U)
    {
      ...
      USB_SetDevSpeed (USBx , 0U);
    }
    else
    {

      USB_SetDevSpeed (USBx , 1U);
    }
  }
  else
  {

    USB_SetDevSpeed (USBx , 3U);
  }
  ...
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPMSK = 0U;
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DOEPMSK = 0U;
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINT = 0xFFFFFFFFU;
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK = 0U;

  for (i = 0U; i < cfg.dev_endpoints; i++)
  {
    if ((((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (i)*((uint32_t )0x20U)))->DIEPCTL & ((uint32_t)0x80000000U)) == ((uint32_t)0x80000000U))
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (i)*((uint32_t )0x20U)))->DIEPCTL = (((uint32_t)0x40000000U) | ((uint32_t)0x08000000U));
    }
    else
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (i)*((uint32_t )0x20U)))->DIEPCTL = 0U;
    }

    ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (i)*((uint32_t )0x20U)))->DIEPTSIZ = 0U;
    ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (i)*((uint32_t )0x20U)))->DIEPINT = 0xFFU;
  }

  for (i = 0U; i < cfg.dev_endpoints; i++)
  {
    if ((((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (i)*((uint32_t )0x20U)))->DOEPCTL & ((uint32_t)0x80000000U)) == ((uint32_t)0x80000000U))
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (i)*((uint32_t )0x20U)))->DOEPCTL = (((uint32_t)0x40000000U) | ((uint32_t)0x08000000U));
    }
    else
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (i)*((uint32_t )0x20U)))->DOEPCTL = 0U;
    }

    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (i)*((uint32_t )0x20U)))->DOEPTSIZ = 0U;
    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (i)*((uint32_t )0x20U)))->DOEPINT = 0xFFU;
  }

  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPMSK &= ~(((uint32_t)0x00000100U));

  if (cfg.dma_enable == 1U)
  {

    ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DTHRCTL = (((uint32_t)0x00000100U) | ((uint32_t)0x00800000U));
    ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DTHRCTL |= (((uint32_t)0x00010000U) | ((uint32_t)0x00000002U) | ((uint32_t)0x00000001U));

    i= ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DTHRCTL;
  }
  ...
  {
    USBx->GINTMSK |= ((uint32_t)0x00000010U);
  }


  USBx->GINTMSK |= (((uint32_t)0x00000800U) | ((uint32_t)0x00001000U) |
                    ((uint32_t)0x00002000U) | ((uint32_t)0x00040000U) |
                    ((uint32_t)0x00080000U) | ((uint32_t)0x00100000U)|
                    ((uint32_t)0x00200000U) | ((uint32_t)0x80000000U));

  if(cfg.Sof_enable)
  {
    USBx->GINTMSK |= ((uint32_t)0x00000008U);
  }

  if (cfg.vbus_sensing_enable == ENABLE)
  {
    USBx->GINTMSK |= (((uint32_t)0x40000000U) | ((uint32_t)0x00000004U));
  }

  return HAL_OK;
}
# 346 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_FlushTxFifo (USB_OTG_GlobalTypeDef *USBx, uint32_t num )
{
  uint32_t count = 0U;

  USBx->GRSTCTL = ( ((uint32_t)0x00000020U) |(uint32_t)( num << 6));
  ...
  while ((USBx->GRSTCTL & ((uint32_t)0x00000020U)) == ((uint32_t)0x00000020U));
...
HAL_StatusTypeDef USB_FlushRxFifo(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  USBx->GRSTCTL = ((uint32_t)0x00000010U);
  ...
  while ((USBx->GRSTCTL & ((uint32_t)0x00000010U)) == ((uint32_t)0x00000010U));

  return HAL_OK;
}
# 400 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_SetDevSpeed(USB_OTG_GlobalTypeDef *USBx , uint8_t speed)
{
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCFG |= speed;
  return HAL_OK;
}
# 415 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
uint8_t USB_GetDevSpeed(USB_OTG_GlobalTypeDef *USBx)
{
  uint8_t speed = 0U;

  if((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000006U)) == (0U << 1U))
  {
    speed = 0U;
  }
  else if (((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000006U)) == (1U << 1U))||
           ((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000006U)) == (3U << 1U)))
  {
    speed = 3U;
  }
  else if((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000006U)) == (2U << 1U))
  {
    speed = 2U;
  }
...
HAL_StatusTypeDef USB_ActivateEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  if (ep->is_in == 1U)
  {
   ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK |= ((uint32_t)0x0000FFFFU) & ((1U << (ep->num)));

    if (((((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL) & ((uint32_t)0x00008000U)) == 0U)
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL |= ((ep->maxpacket & ((uint32_t)0x000007FFU) ) | (ep->type << 18U) |
        ((ep->num) << 22U) | (((uint32_t)0x10000000U)) | (((uint32_t)0x00008000U)));
    }
  }
  else
  {
     ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK |= ((uint32_t)0xFFFF0000U) & ((1U << (ep->num)) << 16U);

    if (((((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL) & ((uint32_t)0x00008000U)) == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= ((ep->maxpacket & ((uint32_t)0x000007FFU) ) | (ep->type << 18U) |
       (((uint32_t)0x10000000U))| (((uint32_t)0x00008000U)));
    }
  }
  return HAL_OK;
}
...
HAL_StatusTypeDef USB_ActivateDedicatedEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
    ...
    debug |= ((ep->maxpacket & ((uint32_t)0x000007FFU) ) | (ep->type << 18U) |
        ((ep->num) << 22U) | (((uint32_t)0x10000000U)) | (((uint32_t)0x00008000U)));

   ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DEACHMSK |= ((uint32_t)0x0000FFFFU) & ((1U << (ep->num)));
  }
  else
  {
    if (((((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL) & ((uint32_t)0x00008000U)) == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= ((ep->maxpacket & ((uint32_t)0x000007FFU) ) | (ep->type << 18U) |
        ((ep->num) << 22U) | (((uint32_t)0x00008000U)));

      debug = (uint32_t)(((uint32_t )USBx) + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U));
      debug = (uint32_t )&((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL;
      debug |= ((ep->maxpacket & ((uint32_t)0x000007FFU) ) | (ep->type << 18U) |
        ((ep->num) << 22U) | (((uint32_t)0x00008000U)));
    }

     ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DEACHMSK |= ((uint32_t)0xFFFF0000U) & ((1U << (ep->num)) << 16U);
  }
...
HAL_StatusTypeDef USB_DeactivateEndpoint(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  ...
  if (ep->is_in == 1U)
  {
   ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DEACHMSK &= ~(((uint32_t)0x0000FFFFU) & ((1U << (ep->num))));
   ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK &= ~(((uint32_t)0x0000FFFFU) & ((1U << (ep->num))));
   ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL &= ~ ((uint32_t)0x00008000U);
  }
  else
  {
     ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DEACHMSK &= ~(((uint32_t)0xFFFF0000U) & ((1U << (ep->num)) << 16U));
     ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK &= ~(((uint32_t)0xFFFF0000U) & ((1U << (ep->num)) << 16U));
     ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL &= ~((uint32_t)0x00008000U);
  }
  return HAL_OK;
}
...
# 565 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_EPStartXfer(USB_OTG_GlobalTypeDef *USBx , USB_OTG_EPTypeDef *ep, uint8_t dma)
{
  uint16_t pktcnt = 0U;
  ...
  if (ep->is_in == 1U)
  {
    ...
    if (ep->xfer_len == 0U)
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ &= ~(((uint32_t)0x1FF80000U));
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ |= (((uint32_t)0x1FF80000U) & (1U << 19U)) ;
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ &= ~(((uint32_t)0x0007FFFFU));
    }
    else
    {
      ...
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ &= ~(((uint32_t)0x0007FFFFU));
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ &= ~(((uint32_t)0x1FF80000U));
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ |= (((uint32_t)0x1FF80000U) & (((ep->xfer_len + ep->maxpacket -1U)/ ep->maxpacket) << 19U)) ;
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ |= (((uint32_t)0x0007FFFFU) & ep->xfer_len);

      if (ep->type == 1U)
      {
        ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ &= ~(((uint32_t)0x60000000U));
        ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPTSIZ |= (((uint32_t)0x60000000U) & (1U << 29U));
      }
    }

    if (dma == 1U)
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPDMA = (uint32_t)(ep->dma_addr);
    }
    else
    {
      if (ep->type != 1U)
      {
        ...
        if (ep->xfer_len > 0U)
        {
          ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPEMPMSK |= 1U << ep->num;
        }
      }
    }
    ...
    if (ep->type == 1U)
    {
      if ((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ( 1U << 8U )) == 0U)
      {
        ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL |= ((uint32_t)0x20000000U);
      }
      else
      {
        ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL |= ((uint32_t)0x10000000U);
      }
    }


    ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL |= (((uint32_t)0x04000000U) | ((uint32_t)0x80000000U));
  ...
  else
  {
    ...
    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ &= ~(((uint32_t)0x0007FFFFU));
    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ &= ~(((uint32_t)0x1FF80000U));

    if (ep->xfer_len == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ |= (((uint32_t)0x0007FFFFU) & ep->maxpacket);
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ |= (((uint32_t)0x1FF80000U) & (1U << 19U));
    }
    else
    {
      pktcnt = (ep->xfer_len + ep->maxpacket -1U)/ ep->maxpacket;
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ |= (((uint32_t)0x1FF80000U) & (pktcnt << 19U));
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPTSIZ |= (((uint32_t)0x0007FFFFU) & (ep->maxpacket * pktcnt));
    }

    if (dma == 1U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPDMA = (uint32_t)ep->xfer_buff;
    }
    ...
    if (ep->type == 1U)
    {
      if ((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ( 1U << 8U )) == 0U)
      {
        ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= ((uint32_t)0x20000000U);
      }
      else
      {
        ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= ((uint32_t)0x10000000U);
      }
    }

    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= (((uint32_t)0x04000000U) | ((uint32_t)0x80000000U));
  }
  return HAL_OK;
}
# 687 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_EP0StartXfer(USB_OTG_GlobalTypeDef *USBx , USB_OTG_EPTypeDef *ep, uint8_t dma)
{
...
# 776 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_WritePacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *src, uint8_t ch_ep_num, uint16_t len, uint8_t dma)
{
  ...
  if (dma == 0U)
  {
    ...
    {
      *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x1000U) + (ch_ep_num) * ((uint32_t )0x1000U)) = *((
# 785 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c" 3
                                __attribute__((__packed__)) 
# 785 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
                                         uint32_t *)src);
    }
  }
  return HAL_OK;
}
# 804 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
void *USB_ReadPacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *dest, uint16_t len)
{
  uint32_t i=0U;
  ...
  {
    *(
# 811 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c" 3
     __attribute__((__packed__)) 
# 811 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
              uint32_t *)dest = *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x1000U) + (0U) * ((uint32_t )0x1000U));
...
HAL_StatusTypeDef USB_EPSetStall(USB_OTG_GlobalTypeDef *USBx , USB_OTG_EPTypeDef *ep)
{
  if (ep->is_in == 1U)
  {
    if (((((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL) & ((uint32_t)0x80000000U)) == 0U)
    {
      ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL &= ~(((uint32_t)0x40000000U));
    }
    ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (ep->num)*((uint32_t )0x20U)))->DIEPCTL |= ((uint32_t)0x00200000U);
  }
  else
  {
    if (((((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL) & ((uint32_t)0x80000000U)) == 0U)
    {
      ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL &= ~(((uint32_t)0x40000000U));
    }
    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (ep->num)*((uint32_t )0x20U)))->DOEPCTL |= ((uint32_t)0x00200000U);
  }
  return HAL_OK;
}
# 851 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_EPClearStall(USB_OTG_GlobalTypeDef *USBx, USB_OTG_EPTypeDef *ep)
{
  if (ep->is_in == 1U)
  {
...
# 908 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_SetDevAddress (USB_OTG_GlobalTypeDef *USBx, uint8_t address)
{
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCFG &= ~ (((uint32_t)0x000007F0U));
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCFG |= (address << 4U) & ((uint32_t)0x000007F0U) ;
...
HAL_StatusTypeDef USB_DevConnect (USB_OTG_GlobalTypeDef *USBx)
{
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCTL &= ~((uint32_t)0x00000002U) ;
  HAL_Delay(3U);
...
{
  uint32_t v;
  v = ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINT;
  v &= ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DAINTMSK;
...
# 989 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
uint32_t USB_ReadDevOutEPInterrupt (USB_OTG_GlobalTypeDef *USBx , uint8_t epnum)
{
  uint32_t v;
  v = ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (epnum)*((uint32_t )0x20U)))->DOEPINT;
  v &= ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DOEPMSK;
  return v;
}
# 1004 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
uint32_t USB_ReadDevInEPInterrupt (USB_OTG_GlobalTypeDef *USBx , uint8_t epnum)
{
  uint32_t v, msk, emp;

  msk = ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPMSK;
  emp = ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DIEPEMPMSK;
  msk |= ((emp >> epnum) & 0x1U) << 7U;
  v = ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (epnum)*((uint32_t )0x20U)))->DIEPINT & msk;
  return v;
}
...
# 1034 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
uint32_t USB_GetMode(USB_OTG_GlobalTypeDef *USBx)
{
...
HAL_StatusTypeDef USB_ActivateSetup (USB_OTG_GlobalTypeDef *USBx)
{
  ...
  ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (0U)*((uint32_t )0x20U)))->DIEPCTL &= ~((uint32_t)0x000007FFU);

  if((((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DSTS & ((uint32_t)0x00000006U)) == (2U << 1U))
  {
    ((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900U) + (0U)*((uint32_t )0x20U)))->DIEPCTL |= 3U;
  }
  ((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800U)))->DCTL |= ((uint32_t)0x00000100U);

  return HAL_OK;
}
# 1070 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_EP0_OutStart(USB_OTG_GlobalTypeDef *USBx, uint8_t dma, uint8_t *psetup)
{
  ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPTSIZ = 0U;
  ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPTSIZ |= (((uint32_t)0x1FF80000U) & (1U << 19U)) ;
  ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPTSIZ |= (3U * 8U);
  ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPTSIZ |= ((uint32_t)0x60000000U);

  if (dma == 1U)
  {
    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPDMA = (uint32_t)psetup;

    ((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00U) + (0U)*((uint32_t )0x20U)))->DOEPCTL = 0x80008000U;
  }
...
static HAL_StatusTypeDef USB_CoreReset(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  while ((USBx->GRSTCTL & ((uint32_t)0x80000000U)) == 0U);


  count = 0U;
  USBx->GRSTCTL |= ((uint32_t)0x00000001U);
  ...
  while ((USBx->GRSTCTL & ((uint32_t)0x00000001U)) == ((uint32_t)0x00000001U));

  return HAL_OK;
}
# 1132 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_HostInit (USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  uint32_t i;
  ...
  *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0xE00U)) = 0U;
  ...
  USBx->GCCFG &=~ (((uint32_t)0x00040000U));
  USBx->GCCFG &=~ (((uint32_t)0x00080000U));
  USBx->GCCFG |= ((uint32_t)0x00200000U);
  ...
  if((cfg.speed == 3U)&&
     (USBx != ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x50000000U))))
  {
    ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HCFG |= ((uint32_t)0x00000004U);
  }
  else
  {
    ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HCFG &= ~(((uint32_t)0x00000004U));
  ...
  {
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (i)*((uint32_t )0x20U)))->HCINT = 0xFFFFFFFFU;
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (i)*((uint32_t )0x20U)))->HCINTMSK = 0U;
  }
  ...
  if(USBx == ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x50000000U)))
  {

    USBx->GRXFSIZ = (uint32_t )0x80U;
    USBx->DIEPTXF0_HNPTXFSIZ = (uint32_t )(((0x60U << 16U)& ((uint32_t)0xFFFF0000U)) | 0x80U);
    USBx->HPTXFSIZ = (uint32_t )(((0x40U << 16U)& ((uint32_t)0xFFFF0000U)) | 0xE0U);
  }
  else
  {

    USBx->GRXFSIZ = (uint32_t )0x200U;
    USBx->DIEPTXF0_HNPTXFSIZ = (uint32_t )(((0x100U << 16U)& ((uint32_t)0xFFFF0000U)) | 0x200U);
    USBx->HPTXFSIZ = (uint32_t )(((0xE0U << 16U)& ((uint32_t)0xFFFF0000U)) | 0x300U);
  }
  ...
  USBx->GINTMSK |= (((uint32_t)0x01000000U) | ((uint32_t)0x02000000U) |
                    ((uint32_t)0x00000008U) |((uint32_t)0x20000000U)|
                    ((uint32_t)0x00200000U) | ((uint32_t)0x80000000U));

  return HAL_OK;
}
# 1220 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_InitFSLSPClkSel(USB_OTG_GlobalTypeDef *USBx , uint8_t freq)
{
  ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HCFG &= ~(((uint32_t)0x00000003U));
  ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HCFG |= (freq & ((uint32_t)0x00000003U));

  if (freq == 1U)
  {
    ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HFIR = (uint32_t)48000U;
  }
  else if (freq == 2U)
  {
    ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HFIR = (uint32_t)6000U;
  }
  return HAL_OK;
}
# 1243 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_ResetPort(USB_OTG_GlobalTypeDef *USBx)
{
  volatile uint32_t hprt0;

  hprt0 = *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U));

  hprt0 &= ~(((uint32_t)0x00000004U) | ((uint32_t)0x00000002U) |
    ((uint32_t)0x00000008U) | ((uint32_t)0x00000020U) );

  *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U)) = (((uint32_t)0x00000100U) | hprt0);
  HAL_Delay (10U);
  *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U)) = ((~((uint32_t)0x00000100U)) & hprt0);
  return HAL_OK;
}
# 1266 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_DriveVbus (USB_OTG_GlobalTypeDef *USBx, uint8_t state)
{
  volatile uint32_t hprt0;
  ...
  if (((hprt0 & ((uint32_t)0x00001000U)) == 0U) && (state == 1U))
  {
    *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U)) = (((uint32_t)0x00001000U) | hprt0);
  }
  if (((hprt0 & ((uint32_t)0x00001000U)) == ((uint32_t)0x00001000U)) && (state == 0U))
  {
    *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U)) = ((~((uint32_t)0x00001000U)) & hprt0);
  }
  return HAL_OK;
}
# 1294 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
uint32_t USB_GetHostSpeed (USB_OTG_GlobalTypeDef *USBx)
{
  volatile uint32_t hprt0;

  hprt0 = *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0x440U));
  return ((hprt0 & ((uint32_t)0x00060000U)) >> 17U);
}
...
uint32_t USB_GetCurrentFrame (USB_OTG_GlobalTypeDef *USBx)
{
  return (((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HFNUM & ((uint32_t)0x0000FFFFU));
}
# 1336 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_HC_Init(USB_OTG_GlobalTypeDef *USBx,
                              uint8_t ch_num,
                              uint8_t epnum,
                              uint8_t dev_address,
                              ...
                              uint16_t mps)
{
  ...
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINT = 0xFFFFFFFFU;
  ...
  case 2U:
    ...
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINTMSK = ((uint32_t)0x00000001U) |
                                ((uint32_t)0x00000008U) |
                                ((uint32_t)0x00000080U) |
    ...
    if (epnum & 0x80U)
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINTMSK |= ((uint32_t)0x00000100U);
    }
    else
    {
      if(USBx != ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x50000000U)))
      {
        ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINTMSK |= (((uint32_t)0x00000040U) | ((uint32_t)0x00000020U));
      }
    }
    break;
  ...
  case 1U:
    ...
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINTMSK = ((uint32_t)0x00000001U) |
                                ((uint32_t)0x00000020U) |
                                ((uint32_t)0x00000004U) |
                                ((uint32_t)0x00000200U) ;

    if (epnum & 0x80U)
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCINTMSK |= (((uint32_t)0x00000080U) | ((uint32_t)0x00000100U));
    }
    break;
  }


  ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HAINTMSK |= (1 << ch_num);


  USBx->GINTMSK |= ((uint32_t)0x02000000U);


  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCCHAR = (((dev_address << 22U) & ((uint32_t)0x1FC00000U)) |
                             (((epnum & 0x7FU)<< 11U) & ((uint32_t)0x00007800U))|
                             ((((epnum & 0x80U) == 0x80U)<< 15U) & ((uint32_t)0x00008000U))|
                             (((speed == 2U)<< 17U) & ((uint32_t)0x00020000U))|
                             ((ep_type << 18U) & ((uint32_t)0x000C0000U))|
                             (mps & ((uint32_t)0x000007FFU)));

  if (ep_type == 3U)
  {
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCCHAR |= ((uint32_t)0x20000000U) ;
  }

  return HAL_OK;
}
# 1439 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
...
HAL_StatusTypeDef USB_HC_StartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_HCTypeDef *hc, uint8_t dma)
{
  ...
  if((USBx != ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x50000000U))) && (hc->speed == 0U))
  {
    ...
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCINTMSK &= ~(((uint32_t)0x00000040U) | ((uint32_t)0x00000020U));
      hc->do_ping = 0U;
    }
  }
  ...
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCTSIZ = (((hc->xfer_len) & ((uint32_t)0x0007FFFFU))) |
    ((num_packets << 19U) & ((uint32_t)0x1FF80000U)) |
      (((hc->data_pid) << 29U) & ((uint32_t)0x60000000U));

  if (dma)
  {

    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCDMA = (uint32_t)hc->xfer_buff;
  }

  is_oddframe = (((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HFNUM & 0x01U) ? 0U : 1U;
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCCHAR &= ~((uint32_t)0x20000000U);
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCCHAR |= (is_oddframe << 29U);


  tmpreg = ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCCHAR;
  tmpreg &= ~((uint32_t)0x40000000U);
  tmpreg |= ((uint32_t)0x80000000U);
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc->ch_num)*((uint32_t )0x20U)))->HCCHAR = tmpreg;
    ...
    if((hc->ep_is_in == 0U) && (hc->xfer_len > 0U))
    {
      ...
      case 2U:
        ...
        if(len_words > (USBx->HNPTXSTS & 0xFFFFU))
        {
          ...
          USBx->GINTMSK |= ((uint32_t)0x00000020U);
        }
        break;
      ...
      case 1U:
        ...
        if(len_words > (((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HPTXSTS & 0xFFFFU))
        {

          USBx->GINTMSK |= ((uint32_t)0x04000000U);
        }
        break;
...
uint32_t USB_HC_ReadInterrupt (USB_OTG_GlobalTypeDef *USBx)
{
  return ((((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HAINT) & 0xFFFFU);
}
# 1564 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_HC_Halt(USB_OTG_GlobalTypeDef *USBx , uint8_t hc_num)
{
  uint32_t count = 0U;


  if (((((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR) & (0U << 18U)) || ((((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR) & (2U << 18U)))
  {
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR |= ((uint32_t)0x40000000U);

    if ((USBx->HNPTXSTS & 0xFFFFU) == 0U)
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR &= ~((uint32_t)0x80000000U);
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR |= ((uint32_t)0x80000000U);
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR &= ~((uint32_t)0x00008000U);
      do
      {
        if (++count > 1000U)
        {
      ...
      while ((((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR & ((uint32_t)0x80000000U)) == ((uint32_t)0x80000000U));
    }
    else
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR |= ((uint32_t)0x80000000U);
  ...
  else
  {
    ...
    if ((((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HPTXSTS & 0xFFFFU) == 0U)
    {
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR &= ~((uint32_t)0x80000000U);
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR |= ((uint32_t)0x80000000U);
      ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (hc_num)*((uint32_t )0x20U)))->HCCHAR &= ~((uint32_t)0x00008000U);
...
# 1626 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
HAL_StatusTypeDef USB_DoPing(USB_OTG_GlobalTypeDef *USBx , uint8_t ch_num)
{
  uint8_t num_packets = 1U;
  uint32_t tmpreg = 0U;

  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCTSIZ = ((num_packets << 19U) & ((uint32_t)0x1FF80000U)) |
                                ((uint32_t)0x80000000U);


  tmpreg = ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCCHAR;
  tmpreg &= ~((uint32_t)0x40000000U);
  tmpreg |= ((uint32_t)0x80000000U);
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (ch_num)*((uint32_t )0x20U)))->HCCHAR = tmpreg;
...
HAL_StatusTypeDef USB_StopHost(USB_OTG_GlobalTypeDef *USBx)
{
  ...
  for (i = 0U; i <= 15U; i++)
  {
    ...
    value = ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (i)*((uint32_t )0x20U)))->HCCHAR ;
    value |= ((uint32_t)0x40000000U);
    value &= ~((uint32_t)0x80000000U);
    value &= ~((uint32_t)0x00008000U);
    ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (i)*((uint32_t )0x20U)))->HCCHAR = value;
  }
  ...
  for (i = 0U; i <= 15U; i++)
  {
    ...
    while ((((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500U) + (i)*((uint32_t )0x20U)))->HCCHAR & ((uint32_t)0x80000000U)) == ((uint32_t)0x80000000U));
  }


  ((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400U)))->HAINT = 0xFFFFFFFFU;
  USBx->GINTSTS = 0xFFFFFFFFU;
