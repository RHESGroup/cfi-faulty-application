# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c"
# 36 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.h" 1
# 42 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.h"
...
# 43 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.h" 2
...
# 37 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c" 2
...
# 39 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c" 2
...
# 40 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c" 2
...
void MX_SDIO_SD_Init(void)
{
  ...
  hsd.Instance = ((SDIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x2C00U));
  hsd.Init.ClockEdge = ((uint32_t)0x00000000U);
  hsd.Init.ClockBypass = ((uint32_t)0x00000000U);
  hsd.Init.ClockPowerSave = ((uint32_t)0x00000000U);
  hsd.Init.BusWide = ((uint32_t)0x00000000U);
  hsd.Init.HardwareFlowControl = ((uint32_t)0x00000000U);
  hsd.Init.ClockDiv = 0;
  HAL_SD_Init(&hsd, &SDCardInfo);

  HAL_SD_WideBusOperation_Config(&hsd, ((uint32_t)0x0800U));
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  if(hsd->Instance==((SDIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x2C00U)))
  {




    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2ENR) |= (((uint32_t)0x00000800U))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2ENR) & (((uint32_t)0x00000800U))); ((void)(tmpreg)); } while(0);
# 88 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c"
    GPIO_InitStruct.Pin = ((uint16_t)0x1000U)|((uint16_t)0x0800U)|((uint16_t)0x0400U)|((uint16_t)0x0200U)
                          |((uint16_t)0x0100U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0004U);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000002U);
    GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
    GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
    GPIO_InitStruct.Alternate = ((uint8_t)0x0CU);
    ...
    hdma_sdio_rx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000U) + 0x00020000U) + 0x6400U) + 0x058U));
    hdma_sdio_rx.Init.Channel = ((uint32_t)0x08000000U);
    hdma_sdio_rx.Init.Direction = ((uint32_t)0x00000000U);
    hdma_sdio_rx.Init.PeriphInc = ((uint32_t)0x00000000U);
    hdma_sdio_rx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400U));
    hdma_sdio_rx.Init.PeriphDataAlignment = ((uint32_t)((uint32_t)0x00001000U));
    hdma_sdio_rx.Init.MemDataAlignment = ((uint32_t)((uint32_t)0x00004000U));
    hdma_sdio_rx.Init.Mode = ((uint32_t)((uint32_t)0x00000020U));
    hdma_sdio_rx.Init.Priority = ((uint32_t)((uint32_t)0x00030000U));
    hdma_sdio_rx.Init.FIFOMode = ((uint32_t)((uint32_t)0x00000004U));
    hdma_sdio_rx.Init.FIFOThreshold = ((uint32_t)((uint32_t)0x00000003U));
    hdma_sdio_rx.Init.MemBurst = ((uint32_t)((uint32_t)0x00800000U));
    hdma_sdio_rx.Init.PeriphBurst = ((uint32_t)((uint32_t)0x00200000U));
    HAL_DMA_Init(&hdma_sdio_rx);

    do{ (hsd)->hdmarx = &(hdma_sdio_rx); (hdma_sdio_rx).Parent = (hsd); } while(0);

    hdma_sdio_tx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000U) + 0x00020000U) + 0x6400U) + 0x0A0U));
    hdma_sdio_tx.Init.Channel = ((uint32_t)0x08000000U);
    hdma_sdio_tx.Init.Direction = ((uint32_t)((uint32_t)0x00000040U));
    hdma_sdio_tx.Init.PeriphInc = ((uint32_t)0x00000000U);
    hdma_sdio_tx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400U));
    hdma_sdio_tx.Init.PeriphDataAlignment = ((uint32_t)((uint32_t)0x00001000U));
    hdma_sdio_tx.Init.MemDataAlignment = ((uint32_t)((uint32_t)0x00004000U));
    hdma_sdio_tx.Init.Mode = ((uint32_t)((uint32_t)0x00000020U));
    hdma_sdio_tx.Init.Priority = ((uint32_t)((uint32_t)0x00030000U));
    hdma_sdio_tx.Init.FIFOMode = ((uint32_t)((uint32_t)0x00000004U));
    hdma_sdio_tx.Init.FIFOThreshold = ((uint32_t)((uint32_t)0x00000003U));
    hdma_sdio_tx.Init.MemBurst = ((uint32_t)((uint32_t)0x00800000U));
    hdma_sdio_tx.Init.PeriphBurst = ((uint32_t)((uint32_t)0x00200000U));
    HAL_DMA_Init(&hdma_sdio_tx);

    do{ (hsd)->hdmatx = &(hdma_sdio_tx); (hdma_sdio_tx).Parent = (hsd); } while(0);
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  ...
  if(hsd->Instance==((SDIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x2C00U)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2ENR &= ~(((uint32_t)0x00000800U)));
# 167 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/sdio.c"
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0800U)), ((uint16_t)0x1000U)|((uint16_t)0x0800U)|((uint16_t)0x0400U)|((uint16_t)0x0200U)
                          |((uint16_t)0x0100U));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0004U));
