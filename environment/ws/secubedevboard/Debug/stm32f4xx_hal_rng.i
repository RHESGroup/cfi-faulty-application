# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
# 60 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
...
# 61 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c" 2
# 122 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
{

  if(hrng == 
# 125 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c" 3 4
            ((void *)0)
# 125 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
                )
  {
    return HAL_ERROR;
  }

  do{ if((hrng)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hrng)->Lock = HAL_LOCKED; } }while (0);
  ...
  ((hrng)->Instance->CR |= ((uint32_t)0x00000004U));


  hrng->State = HAL_RNG_STATE_READY;

  do{ (hrng)->Lock = HAL_UNLOCKED; }while (0);
...
HAL_StatusTypeDef HAL_RNG_DeInit(RNG_HandleTypeDef *hrng)
{
  ...
  if(hrng == 
# 164 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c" 3 4
            ((void *)0)
# 164 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
                )
  {
    return HAL_ERROR;
  }

  ((hrng->Instance->CR) &= ~(((uint32_t)0x00000008U) | ((uint32_t)0x00000004U)));


  ((hrng->Instance->SR) &= ~(((uint32_t)0x00000020U) | ((uint32_t)0x00000040U)));
...
__attribute__((weak)) void HAL_RNG_MspInit(RNG_HandleTypeDef *hrng)
{
...
__attribute__((weak)) void HAL_RNG_MspDeInit(RNG_HandleTypeDef *hrng)
{
...
# 247 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_StatusTypeDef HAL_RNG_GenerateRandomNumber(RNG_HandleTypeDef *hrng, uint32_t *random32bit)
{
  ...
  if(hrng->State == HAL_RNG_STATE_READY)
  {
    ...
    while((((hrng)->Instance->SR & (((uint32_t)0x00000001U))) == (((uint32_t)0x00000001U))) == RESET)
    {
...
HAL_StatusTypeDef HAL_RNG_GenerateRandomNumber_IT(RNG_HandleTypeDef *hrng)
{
  ...
  if(hrng->State == HAL_RNG_STATE_READY)
  {
    ...
    ((hrng)->Instance->CR |= ((uint32_t)0x00000008U));
  }
  else
  {
...
# 352 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
void HAL_RNG_IRQHandler(RNG_HandleTypeDef *hrng)
{

  if(((((hrng)->Instance->SR & (((uint32_t)0x00000020U))) == (((uint32_t)0x00000020U))) != RESET) || ((((hrng)->Instance->SR & (((uint32_t)0x00000040U))) == (((uint32_t)0x00000040U))) != RESET))
  {
  ...
  if((((hrng)->Instance->SR & (((uint32_t)0x00000001U))) == (((uint32_t)0x00000001U))) != RESET)
  {
...
# 394 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
uint32_t HAL_RNG_GetRandomNumber(RNG_HandleTypeDef *hrng)
{
...
# 413 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
uint32_t HAL_RNG_GetRandomNumber_IT(RNG_HandleTypeDef *hrng)
{
...
# 451 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
__attribute__((weak)) void HAL_RNG_ReadyDataCallback(RNG_HandleTypeDef *hrng, uint32_t random32bit)
{
...
__attribute__((weak)) void HAL_RNG_ErrorCallback(RNG_HandleTypeDef *hrng)
{
...
# 501 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rng.c"
HAL_RNG_StateTypeDef HAL_RNG_GetState(RNG_HandleTypeDef *hrng)
{
  return hrng->State;
}
