# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
# 29 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
void MSC_BOT_CplClrFeature (USBD_HandleTypeDef *pdev,
                             uint8_t epnum);
# 30 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
...
void SCSI_SenseCode(USBD_HandleTypeDef *pdev,
                      ...
                      uint8_t sKey,
                      uint8_t ASC);
# 31 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
...
# 32 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/class/msc/Inc/usbd_msc_data.h" 1
# 81 "/Users/nico/Desktop/SEcube firmware 2/environment/middlewares/st/stm32_usb_device_library/class/msc/Inc/usbd_msc_data.h"
extern const uint8_t MSC_Page00_Inquiry_Data[];
extern const uint8_t MSC_Mode_Sense6_data[];
extern const uint8_t MSC_Mode_Sense10_data[] ;
# 33 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c" 2
# 83 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
static int8_t SCSI_ProcessWrite (USBD_HandleTypeDef *pdev,
                                 uint8_t lun);
# 121 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
int8_t SCSI_ProcessCmd(USBD_HandleTypeDef *pdev,
                           uint8_t lun,
                           uint8_t *params)
{
...
# 180 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_TestUnitReady(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
...
# 215 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Inquiry(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  uint8_t* pPage;
  uint16_t len;
  ...
  else
  {
    ...
    pPage = (uint8_t *)&((USBD_StorageTypeDef *)pdev->pUserData)->pInquiry[lun * 0x24];
    len = pPage[4] + 5;
...
# 254 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_ReadCapacity10(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;
...
# 356 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_ModeSense10 (USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  uint16_t len = 8;
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;
...
# 379 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_RequestSense (USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *params)
{
  uint8_t i;
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*)pdev->pClassData;
  ...
  if((hmsc->scsi_sense_head != hmsc->scsi_sense_tail)) {
    ...
    if (hmsc->scsi_sense_head == 4)
    {
      hmsc->scsi_sense_head = 0;
    }
  }
  hmsc->bot_data_length = 0x12;
...
# 422 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
# 455 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Read10(USBD_HandleTypeDef *pdev, uint8_t lun , uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pClassData;
  ...
  hmsc->bot_data_length = 16384;

  return SCSI_ProcessRead(pdev, lun);
}
# 524 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Write10 (USBD_HandleTypeDef *pdev, uint8_t lun , uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pClassData;
  ...
  if (hmsc->bot_state == 0)
  {
    ...
    USBD_LL_PrepareReceive (pdev,
                      0x01,
                      hmsc->bot_data,
                      (((hmsc->scsi_blk_len) < (16384)) ? (hmsc->scsi_blk_len) : (16384)));
  }
  else
  {
...
# 615 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
static int8_t SCSI_Verify10(USBD_HandleTypeDef *pdev, uint8_t lun , uint8_t *params)
{
  USBD_MSC_BOT_HandleTypeDef *hmsc = (USBD_MSC_BOT_HandleTypeDef*) pdev->pClassData;
...
# 647 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
...
static int8_t SCSI_ProcessRead (USBD_HandleTypeDef *pdev, uint8_t lun)
{
  ...
  len = (((hmsc->scsi_blk_len) < (16384)) ? (hmsc->scsi_blk_len) : (16384));
...
# 715 "/Users/nico/Desktop/SEcube firmware 2/environment/Middlewares/ST/STM32_USB_Device_Library/Class/MSC/Src/usbd_msc_scsi.c"
