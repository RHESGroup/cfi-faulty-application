# 1 "../Application/src/stm32f4xx_exti.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../Application/src/stm32f4xx_exti.c"
# 65 "../Application/src/stm32f4xx_exti.c"
# 1 "../Application/src/stm32f4xx_exti.h" 1
# 38 "../Application/src/stm32f4xx_exti.h"
...
# 39 "../Application/src/stm32f4xx_exti.h" 2
# 54 "../Application/src/stm32f4xx_exti.h"
    typedef enum
    {
...
# 80 "../Application/src/stm32f4xx_exti.h"
    typedef struct
    {
        uint32_t EXTI_Line;
...
# 156 "../Application/src/stm32f4xx_exti.h"
...
# 66 "../Application/src/stm32f4xx_exti.c" 2
# 106 "../Application/src/stm32f4xx_exti.c"
void EXTI_DeInit(void)
{
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->IMR = 0x00000000;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->EMR = 0x00000000;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->RTSR = 0x00000000;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->FTSR = 0x00000000;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->PR = 0x007FFFFF;
}
# 122 "../Application/src/stm32f4xx_exti.c"
void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
{
    uint32_t tmp = 0;
    ...
    tmp = (uint32_t)((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U);

    if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
    {

        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->IMR &= ~EXTI_InitStruct->EXTI_Line;
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->EMR &= ~EXTI_InitStruct->EXTI_Line;
        ...
        *(volatile uint32_t *) tmp |= EXTI_InitStruct->EXTI_Line;
        ...
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->RTSR &= ~EXTI_InitStruct->EXTI_Line;
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->FTSR &= ~EXTI_InitStruct->EXTI_Line;
...
# 193 "../Application/src/stm32f4xx_exti.c"
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
{

    ((void)0);

    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->SWIER |= EXTI_Line;
}
# 222 "../Application/src/stm32f4xx_exti.c"
FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
{
    ...
    if ((((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->PR & EXTI_Line) != (uint32_t)RESET)
    {
        bitstatus = SET;
    }
    else
...
void EXTI_ClearFlag(uint32_t EXTI_Line)
{
    ...
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->PR = EXTI_Line;
}
