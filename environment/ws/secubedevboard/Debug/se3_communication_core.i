# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
...
# 9 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 2
...
void se3_communication_core_init()
{
 ...
 memset(&serial, 0, sizeof(SE3_SERIAL));
    ...
    comm.magic_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (16))));
    comm.magic_ready = 
# 50 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                      0
# 50 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                           ;
    comm.req_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (1))));
    comm.locked = 
# 52 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                 0
# 52 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                      ;
    comm.req_ready = 
# 53 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                    0
# 53 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                         ;
    comm.req_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (32))));
    comm.resp_ready = 
# 55 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                     1
# 55 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                         ;
    comm.resp_bmap = 0;
}
# 67 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
static 
# 67 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
      _Bool 
# 67 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
           block_is_magic(const uint8_t* buf)
{
 const uint8_t* a = buf;
 const uint8_t* b = se3_magic;
 size_t i;
 for (i = 0; i < SE3_COMM_BLOCK / SE3_MAGIC_SIZE - 1; i++) {
  if (memcmp(a, b, SE3_MAGIC_SIZE))return 
# 73 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                         0
# 73 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                              ;
        a += SE3_MAGIC_SIZE;
 }
 if (buf[SE3_COMM_BLOCK - 1] >= SE3_COMM_N)return 
# 76 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                                 0
# 76 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                                      ;
 return 
# 77 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
       1
# 77 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
           ;
}
# 88 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
...
# 111 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
...
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
_Bool 
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
     ret = 
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
           1
# 113 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
...
{
    comm.req_ready = 
# 145 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                    0
# 145 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                         ;
    comm.req_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (32))));
}
# 157 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
static void handle_req_recv(int index, const uint8_t* blockdata)
{
    ...
    comm.resp_ready = 
# 165 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                     0
# 165 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                          ;
    ...
    if (index == 0) {
        ...
        do{ memcpy((void*)&(req_hdr.cmd), ((uint8_t*)(comm.req_hdr))+SE3_REQ_OFFSET_CMD, 2); }while(0);
        do{ memcpy((void*)&(req_hdr.cmd_flags), ((uint8_t*)(comm.req_hdr))+SE3_REQ_OFFSET_CMDFLAGS, 2); }while(0);
        do{ memcpy((void*)&(req_hdr.len), ((uint8_t*)(comm.req_hdr))+SE3_REQ_OFFSET_LEN, 2); }while(0);
        do{ memcpy((void*)&(req_hdr.cmdtok[0]), ((uint8_t*)(comm.req_hdr))+SE3_REQ_OFFSET_CMDTOKEN, 4); }while(0);
        ...
        if (nblocks > SE3_COMM_N - 1) {
            ...
            comm.req_bmap = 0;
            comm.resp_ready = 
# 189 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                             1
# 189 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                 ;
        }

        comm.req_bmap &= ((uint32_t)(0xFFFFFFFF >> (32 - (nblocks))));
        do{ comm.req_bmap &= ~(1 << (0)); }while(0);
    }
    else {


        do{ memcpy((void*)&(req_hdr.cmdtok[index]), ((uint8_t*)(blockdata))+SE3_REQDATA_OFFSET_CMDTOKEN, 4); }while(0);
        ...
        do{ memcpy((void*)&(req_hdr.cmdtok[index]), ((uint8_t*)(blockdata))+0, 4); }while(0);

        do{ comm.req_bmap &= ~(1 << (index)); }while(0);
    }

    if (comm.req_bmap == 0) {
        comm.req_ready = 
# 210 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                        1
# 210 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                            ;
        comm.req_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (32))));
        comm.block_guess = 0;
    }
}
# 223 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
int32_t se3_proto_recv(uint8_t lun, const uint8_t* buf, uint32_t blk_addr, uint16_t blk_len)
{
...
# 261 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
   ...
   if (SE3_PROTO_OK != r) return r;
            ...
            if (block_is_magic(data)) {
                ...
                if (comm.magic_ready) {
                    ...
                    comm.magic_ready = 
# 275 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                      0
# 275 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                           ;
                    comm.magic_bmap = ((uint32_t)(0xFFFFFFFF >> (32 - (16))));
                ...
                do{ comm.magic_bmap &= ~(1 << (index)); }while(0);
                if (comm.magic_bmap == 0) {
                    comm.magic_ready = 
# 285 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                      1
# 285 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                          ;
                }
            }
            else{
 ...
 return se3_storage_range_add(&range, lun, 
# 321 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                          ((void *)0)
# 321 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                              , 0xFFFFFFFF, range_write);
}
# 332 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
static void handle_resp_send(int index, uint8_t* blockdata)
{
    ...
    if (index == SE3_COMM_N - 1) {
        ...
        do{ memcpy(((uint8_t*)(blockdata))+SE3_DISCO_OFFSET_STATUS, (void*)&(u16tmp), 2); }while(0);
    }
    else {
        if (comm.resp_ready) {

            if ((comm.resp_bmap & (1<< (index)))) {
                ...
                if (index == 0) {
                    ...
                    u16tmp = 1;
                    do{ memcpy(((uint8_t*)(comm.resp_hdr))+SE3_RESP_OFFSET_READY, (void*)&(u16tmp), 2); }while(0);
                    do{ memcpy(((uint8_t*)(comm.resp_hdr))+SE3_RESP_OFFSET_STATUS, (void*)&(resp_hdr.status), 2); }while(0);
                    do{ memcpy(((uint8_t*)(comm.resp_hdr))+SE3_RESP_OFFSET_LEN, (void*)&(resp_hdr.len), 2); }while(0);
                    do{ memcpy(((uint8_t*)(comm.resp_hdr))+SE3_RESP_OFFSET_CMDTOKEN, (void*)&(resp_hdr.cmdtok[0]), 4); }while(0);
                    ...
                    do{ memcpy(((uint8_t*)(blockdata))+SE3_RESPDATA_OFFSET_CMDTOKEN, (void*)&(resp_hdr.cmdtok[index]), 4); }while(0);
...
int32_t se3_proto_send(uint8_t lun, uint8_t* buf, uint32_t blk_addr, uint16_t blk_len)
{
 ...
 for (block = blk_addr; block < blk_addr + blk_len; block++) {
  ...
  data += SE3_COMM_BLOCK;
    ...
    if (r == SE3_PROTO_OK) r = se3_storage_range_add(&range, lun, 
# 426 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c" 3 4
                                                                 ((void *)0)
# 426 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/Device/se3_communication_core.c"
                                                                     , 0xFFFFFFFF, range_read);
    return r;
}
