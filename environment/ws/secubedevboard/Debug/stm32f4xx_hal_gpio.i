# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
# 126 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
...
# 127 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c" 2
# 189 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  uint32_t position;
  ...
  for(position = 0U; position < ((uint32_t)16U); position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      temp = GPIOx->MODER;
      temp &= ~(((uint32_t)0x00000003U) << (position * 2U));
         ...
         (GPIO_Init->Mode == ((uint32_t)0x00000011U)) || (GPIO_Init->Mode == ((uint32_t)0x00000012U)))
      {
        ...
        temp = GPIOx->OTYPER;
        temp &= ~(((uint32_t)0x00000001U) << position) ;
      ...
      if((GPIO_Init->Mode & ((uint32_t)0x10000000U)) == ((uint32_t)0x10000000U))
      {
        ...
        do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2ENR) |= (((uint32_t)0x00004000U))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x3800U))->APB2ENR) & (((uint32_t)0x00004000U))); ((void)(tmpreg)); } while(0);

        temp = ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[position >> 2U];
        temp &= ~(((uint32_t)0x0FU) << (4U * (position & 0x03U)));
        temp |= ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0000U))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0400U))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0800U))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0C00U))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1000U))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1400U))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1C00U))))? 7U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x2000U))))? 8U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x2400U))))? 9U : 10U)) << (4U * (position & 0x03U)));
        ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[position >> 2U] = temp;


        temp = ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->IMR;
        temp &= ~((uint32_t)iocurrent);
        if((GPIO_Init->Mode & ((uint32_t)0x00010000U)) == ((uint32_t)0x00010000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->IMR = temp;

        temp = ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->EMR;
        temp &= ~((uint32_t)iocurrent);
        if((GPIO_Init->Mode & ((uint32_t)0x00020000U)) == ((uint32_t)0x00020000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->EMR = temp;


        temp = ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->RTSR;
        temp &= ~((uint32_t)iocurrent);
        if((GPIO_Init->Mode & ((uint32_t)0x00100000U)) == ((uint32_t)0x00100000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->RTSR = temp;

        temp = ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->FTSR;
        temp &= ~((uint32_t)iocurrent);
        if((GPIO_Init->Mode & ((uint32_t)0x00200000U)) == ((uint32_t)0x00200000U))
        {
          temp |= iocurrent;
        }
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->FTSR = temp;
      }
    }
  }
}
# 314 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_DeInit(GPIO_TypeDef *GPIOx, uint32_t GPIO_Pin)
{
  uint32_t position;
  uint32_t ioposition = 0x00U;
  ...
  for(position = 0U; position < ((uint32_t)16U); position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      GPIOx->MODER &= ~(((uint32_t)0x00000003U) << (position * 2U));


      GPIOx->AFR[position >> 3U] &= ~((uint32_t)0xFU << ((uint32_t)(position & (uint32_t)0x07U) * 4U)) ;


      GPIOx->OSPEEDR &= ~(((uint32_t)0x00000003U) << (position * 2U));


      GPIOx->OTYPER &= ~(((uint32_t)0x00000001U) << position) ;


      GPIOx->PUPDR &= ~(((uint32_t)0x00000003U) << (position * 2U));


      tmp = ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[position >> 2U];
      tmp &= (((uint32_t)0x0FU) << (4U * (position & 0x03U)));
      if(tmp == ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0000U))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0400U))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0800U))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x0C00U))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1000U))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1400U))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1800U))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x1C00U))))? 7U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x2000U))))? 8U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000U) + 0x00020000U) + 0x2400U))))? 9U : 10U)) << (4U * (position & 0x03U))))
      {

        tmp = ((uint32_t)0x0FU) << (4U * (position & 0x03U));
        ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3800U))->EXTICR[position >> 2U] &= ~tmp;


        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->IMR &= ~((uint32_t)iocurrent);
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->EMR &= ~((uint32_t)iocurrent);


        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->RTSR &= ~((uint32_t)iocurrent);
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->FTSR &= ~((uint32_t)iocurrent);
      }
    }
  }
}
# 395 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
GPIO_PinState HAL_GPIO_ReadPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 430 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_WritePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
...
# 453 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
void HAL_GPIO_TogglePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
# 472 "/Users/nico/Desktop/SEcube firmware 2/environment/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c"
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
  volatile uint32_t tmp = ((uint32_t)0x00010000U);
 ...
 if((GPIOx->LCKR & ((uint32_t)0x00010000U)) != RESET)
  {
    return HAL_OK;
  }
  else
...
void HAL_GPIO_EXTI_IRQHandler(uint16_t GPIO_Pin)
{
  ...
  if((((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->PR & (GPIO_Pin)) != RESET)
  {
    (((EXTI_TypeDef *) ((((uint32_t)0x40000000U) + 0x00010000U) + 0x3C00U))->PR = (GPIO_Pin));
