# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c"
...
# 2 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.h" 2
...
# 3 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.h" 2
...
# 4 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.h" 2
...
# 5 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.h" 2
...
# 2 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c" 2
...
# 3 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c" 2
...
# 4 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c" 2

uint8_t findService(uint8_t* string, uint8_t* uuid, uint8_t* svcIndex){
    char** splits;
    splits = split_string(string, ',', 0);
    if(splits == 
# 8 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c" 3 4
                ((void *)0) 
# 8 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c"
                     || splits[2] == 
# 8 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c" 3 4
                                     ((void *)0)
# 8 "/Users/nico/Desktop/SEcube firmware 2/environment/secube/src/gattInterface.c"
    ...
    if(!strncmp(splits[2], "0xA002", strlen("0xA002") )){
...
uint8_t readChar(uint8_t* line, uint8_t service, uint8_t connection){
    ...
    char** lineSplit;
    uint8_t len;
    sprintf(commandBuffer.buffer, "AT+BLEGATTCRD=%d,%d,%d\r\n", connection, service, 1);
    if(sendCommand(&commandBuffer, 0, 1000)){
        readLine(&inputBuffer, line, 0);
...
void writeResponse(struct output_buffer* cmdBuffer, uint8_t response, uint8_t connIndex, uint8_t svcIndex){
   ...
   switch(response){
       case 0:
        sprintf(cmdBuffer->buffer, "AT+BLEGATTCWR=%d,%d,%d,,%d\r\n",connIndex, svcIndex, 2, strlen("OK"));
        sendCommand(cmdBuffer, 0, 1500);
        sprintf(cmdBuffer->buffer, "OK\r\n");
        sendCommand(cmdBuffer, 0, 500);
        break;
       case 1:
        sprintf(cmdBuffer->buffer, "AT+BLEGATTCWR=%d,%d,%d,,%d\r\n",connIndex, svcIndex, 2, strlen("OUT"));
        sendCommand(cmdBuffer, 0, 1500);
        sprintf(cmdBuffer->buffer, "OUT\r\n");
        sendCommand(cmdBuffer, 0, 500);
        break;
       default:
        sprintf(cmdBuffer->buffer, "AT+BLEGATTCWR=%d,%d,%d,,%d\r\n",connIndex, svcIndex, 2, strlen("system error"));
        sendCommand(cmdBuffer, 0, 1500);
